...
Course Structure
The course is divided into three units. The first unit is entirely an introduction to modeling, and it consists of 6 weeks, the first half of the course. The second half if broken up into two additional units. Unit two focuses on Materials and Texture. Unit 3 focuses on Lighting and Rendering 2D images from student-prepared, 3D scenes. Each lesson include the same general sequence of assignments, but there may be exceptions. Here's a sample schedule for a lesson:

View demonstrations and links on the website
...
Note that some lessons may have additional or fewer assignments. 
Grading Scale:
93–100: A 
90-92: A-
87-89: B+
